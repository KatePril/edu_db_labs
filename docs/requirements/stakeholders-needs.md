...
| ID  | TakeSurvey |
| :------------- | :------------- |
| НАЗВА | Користувач починає проходити опитування.  |
| УЧАСНИКИ | Користувач.  |
| ПЕРЕДУМОВИ | Користувач має бути зареєстрований у системі.  |
| РЕЗУЛЬТАТ | Користувачу показується опитування, та він може його проходити.  |
| ВИКЛЮЧНІ СИТУАЦІЇ | Користувач не зареєстрований у системі. |
| ОСНОВНИЙ СЦЕНАРІЙ | 1. Користувач спочатку авторизується в систему.<br/>2. Дані користувача вносяться у систему </br>3. Система витягує з бази даних створене опитування.<br/>4. Система перенаправляє користувача на вікно з опитуванням, та дає змогу робити в ньому вибір. <br/>   |
