...
| УЧАСНИКИ | Дослідник  |
| ПЕРЕДУМОВИ | Дослідник вже має створене опитуванняю  |
...
| ОСНОВНИЙ СЦЕНАРІЙ | 1. Дослідник переходить на вкладку "Опитування".<br/>2. Дослідник знаходить необхідне опитування та на ньому натискає кнопку "Аналітика".<br/>3. Система витягує данні з бази даних та формує аналітику.<br/>5. Система перенаправляє користувача на вікно з аналітикою опитування. <br/>   |
...
| ОСНОВНИЙ СЦЕНАРІЙ | 1. Дослідник переходить на вкладку "Опитування".<br/>2. Система витягує з бази даних всі створені опитування.<br/>3. Система перенаправляє дослідника на вікно з опитуваннями. <br/>   |
...
| ВИКЛЮЧНІ СИТУАЦІЇ | Респондент не зареєстрований у системі. |
