...
Метою даного розділу є дослідження різних методологій і підходів до розробки ПЗ, таких як Waterfall, Agile, Scrum, Kanban, Прототипування, Lean Development і RAD. Розглянемо переваги та недоліки кожного з цих підходів, щоб надати всебічне уявлення про їх застосування.
...
[Прототип](https://uk.wikipedia.org/wiki/%D0%9F%D1%80%D0%BE%D1%82%D0%BE%D1%82%D0%B8%D0%BF) - попередня версія продукту, створена для перевірки функціональності або дизайну.
...
* Проєктування та дизайн: проєктується майбутня архітектура проєкту у вибраній технології та створюється даптивний дизайн
* Розробка: написання коду та реалізація функціоналу згідно з проєктними вимогами
* Тестування: порівнюється задуманий додаток на етапі аналізу та збору вимог із тим, який створений після етапу розробки, можливе доопрацювання розробниками
* Вихід на ринок: готова та протестована версія продукту випускається на основний сервер і поставляється на ринок
...
* Кращий фокус та попередження виграння у членів команди
